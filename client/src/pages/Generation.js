      ...
      <div className="panel-body">
        ...
        <div className="wrapper">
          ...
          <p>
            ...
            they are describing and interacting with the world around them. Keep
            in mind that these are not hard divisions and a person can relate to
            two cohorts at the same time depending on influences during their
            development. We MUST keep in mind that individual experiences are as
            much, possibly even more responsible, for the individual
            perspectives and attitudes of each person. We can establish a
            baseline understanding of each cohort but as leaders in
            organizations, we are responsible not to generalize to each
            individual but to use cohort information as a clue, further
            gathering individual information in order to best address the
            person. Also, keep in mind that as humans develop and mature, goals
            and ideals change. For example, something like a retirement plan may
            not be important to a person in their teens or early twenties but as
            they mature, future stability may become increasingly important.
          </p>
          <p>
            ...
            Boomers or Generation X but as they begin to have families and look
            toward retirement, this may become increasingly important to them.
            While each generation has experienced certain historical and social
            events that have shaped their upbringing and had an impact on their
            expectations of their world, these expectations are carried into the
            workforce. Expectations have relevance in the long-term recruiting,
            and retention abilities of organizations. These are the expectations
            we need to learn about in order for O&P to be profitable, reduce
            recruiting costs and maximize human capital.
          </p>
          <p>
            It is interesting to note that these generational differences
            translate across countries and are not an issue solely pertaining to
            citizens within the United States however what may be termed as a
          ...
          <p>
            {' '}
            “Workaholic” is a term used to describing this generation of workers
            as they believe in paying your dues and earning respect and
            promotions through this tireless ethic. Their work defines their
            personal fulfillment and self-worth. Boomers may have difficulty
            adapting to new technology. As this group is reaching retirement
            years, health concerns are increasing and we see a shift from more
            manual work to more supervisory roles. It is in this shift that we
            see more conflict in their abilities and technology. This generation
            may be less receptive to the “fast tracking” of the younger
            generations as they have not ”paid their dues”. (Weingarten, R. M.
            2009)
          </p>
          <div
            style={{
          ...
          >
            <p1>
              ...
              (Weingarten, R. M. 2009) They are tired of hearing, "it is
              tradition and we've always done it that way. These individuals are
              pragmatic and view life in survival mode. They can be flexible,
              adaptable, and are not afraid of making decisions. They like
              variety. They are less interested in future planning than their
              parents and have a good yet cynical sense of humor. Gen X is
          ...
          >
            <p1>
              ...
              Generation X they are self-reliant, independent and goal oriented.
              They tend to be more relaxed than previous generations and are
              able to take uncertainty in stride. They are team oriented like
              the Boomers. They want their jobs to be meaningful and have an
