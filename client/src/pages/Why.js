        ...
        <div className="panel-body">
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              <p>
                ...
                Leadership and Management facilitate engagement through
                organizational citizenship? As we begin to examine our own
                clinical workforce we must take into account individual
                preferences for leadership behavior and acknowledge that this
                may require a shift in leadership attitude, policy, and
                implementation. (Ahn & Ettner, 2017) The accepted leadership
                behavior in some organizations outside Orthotics and Prosthetics
                is transformational leadership, a style of leadership where a
              ...
              <p>
                ...
                millennial generation. They are asking how to provide guidance
                to the new generations without alienating the incumbent
                workforce while providing a structure to leadership.
                (Weingarten, 2009)
              </p>
              <p>
                As we may see, the field of nursing deals with similar
                leadership issues as Orthotics and Prosthetics and can be used
          ...
          <div className="row">
            <div className="col-md-12">
              ...
              >
                <p>
                  “Companies that actively invest in their employees’
                  satisfaction find that individual loyalty to the company is
                  significantly higher. This in turn results in workers’
                  transcending what is asked of them. High employee satisfaction
                  translates to higher productivity without compromising
                  quality, which yields better customer service and increased
                  profits and growth for the company.” (Patel, 2015)
                </p>
                <br />
              </div>
            </div>
