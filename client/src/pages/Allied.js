          ...
          <div className="panel-body">
            <div className="wrapper">
              ...
              <p>
                ...
                literature. I utilized Google Scholar as well as the University
                of Texas Libraries. My goal was to find out what the O&P
                community has as recorded reasons for this imbalance. I wanted
                to find articles on leadership, multigenerational values and
                suggestions of how leadership can address the issues of this
                particular time in history. I was sure I'd find data generated
              ...
              <p>
                ...
                public and recognize changing trends in communication and
                expectations of the workplace. We must also consider that future
                generations may and likely DO have different perspectives around
                health care. These shifts have been documented extensively by
                other professions and show that the millennial generation looks
                at problems through a different lens than we have in the past.
                O&P should embrace a shift toward examining not only our
                biomechanical applications but also to look at how we
                communicate with those that are new to the workforce.
              </p>
              <br />
              <div style={{ display: 'flex', justifyContent: 'center' }}>
                <div>
                  <img
                    src="/css/img/genmakeup.png"
                    alt="some text"
                    width="500"
                  />
                </div>
              ...
              <p>
                ...
                Prosthetics" 2015 review (Whiteside, S. et.al., 2015). These
                tables show the age distribution of practitioners and the ethnic
                make-up of the field. As indicated by the tables above, the
                workforce is evenly distributed between the ages of 25-64 years.
                Because of the relatively even distribution of the current O&P
                workforce across age groups, we are provided an environment to
                share our perspectives relating to generational differences and
                begin to explore why our gender and ethnic distribution are not
                as equally distributed. With this information, we have an
                opportunity for a shift toward transformational leadership and
                an increased awareness of our gender, ethnic, and generational
                diversity. Because we do have a nice distribution of generations
                in the field, now would be an excellent opportunity to look at
                generational perspectives as other allied health professionals
                have done.
              </p>
              ...
              <div className="card">
                ...
                <ul className="list-group list-group-flush">
                  <li className="list-group-item">
                    What are the differences between the Baby Boomers,
                    Generation X, Generation Y, and eventually Generation Z
                    regarding their workplace expectations?
                  </li>
                  <li className="list-group-item">
                    What is the difference between management and leadership?
                  </li>
                  <li className="list-group-item">
                    How can leadership do to promote employee engagement?
                  </li>
                  <li className="list-group-item">
                    How can we engage Generation Y and Generation Z while
                    addressing their needs in employment without alienating
                    previous generations in the workplace?
                  </li>
                  <li className="list-group-item">
                    Can we find commonalities in each generation, strong enough
                    to overcome their differences?
                  </li>
                  <li className="list-group-item">
                    And finally, can we find a common ground within this
                    multigenerational workplace to grow and enhance the way we
                    do business allowing all persons to be engaged and invested
                    in their careers?
                  </li>
                </ul>
              </div>
