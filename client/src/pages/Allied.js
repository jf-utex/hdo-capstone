      ...
      <div className="panel-body">
        ...
        <div className="wrapper">
          <p>
            ...
            are present within genders and different generations. What works for
            a male may not work for a female. What works for a Baby Boomer will
            not always work for Generation Y. Each person regardless of gender
            and generation possesses their own strengths and individual
          ...
          <p>
            ...
            literature. I utilized Google Scholar as well as the University of
            Texas Libraries. My goal was to find out what the O&P community has
            as recorded reasons for this imbalance. I wanted to find articles on
            leadership, multigenerational values and suggestions of how
            leadership can address the issues of this particular time in
            history. I was sure I'd find data generated by the O&P community now
            that research is a requirement to earn a Master's Degree in
            Orthotics and Prosthetics and in order to enter the field.
            <p>
              ...
              addressing organizational behavior and culture in O&P and very few
            ...
            >
              <p>
                <br />
                <p>
                  “These results demonstrate that very little research has been
                  done in the O&P on its own professional culture. Other
                  industries as well as allied medical fields, such as nursing,
                  regularly produce research reflecting on their own practices
                  of mentoring, examinations of workplace culture and
            ...
            >
              <p>
                The specific databases accessed through the University of Texas
                included:
              </p>
              <ul>
            ...
            <p>
              Today, current managerial leadership in Orthotics and Prosthetics
              is taught by “do as I say and sometimes do what I do”. As I have
              learned, this method of mentoring may not be appropriate for those
              newly entering the field. I then began to wonder as I reflect on
              my personal experience in the field… is this method of mentoring
              ever appropriate? Due to recent change in the American health care
              system, it would be advisable to consider the available research
              in health care organizations and even in business and assess if a
              change in O&P leadership practices is indicated. If we are to
              maintain professionalism, improve our patient care practices, and
              maintain marketability, we are obligated to move outside the NUPOC
              definition of "research" and expand our sights to include how
              individuals in our organizations behave.
            </p>
            <p>
              Organizational culture sets an environment that encourages
              employee citizenship. This in turn, often results in the employee
              going “above and beyond” their specific duties to better the
              organization. It has been shown that these immeasurable behaviors
              have a direct impact on the viability of a business. It is the
              culture, behavior and ultimately the citizenship that we seem to
              admire in companies like Southwest Airlines and Apple when the
