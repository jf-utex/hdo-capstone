    ...
    <div id="container">
      <div className="panel panel-default">
        <div className="panel-body">
          ...
          <h3 className="panel-header">Education</h3>
          {/* <div class="row"> */}
          <div className="col-md-8">
            ...
            <p>
              ...
              benefit the patient. They either build a custom device or they
              will have access to prefabricated devices to do this. An orthotist
              and prosthetist will need a physician prescription to provide
              services just as PT, OT, RN or any other health care professional.
            </p>

            <p>
              The difference in orthotics and prosthetics is simple, an
              orthotist must design a device to accommodate a part of the
              anatomy that is inhibiting a patient’s full mobility potential. A
              prosthetist on the other hand, must provide componentry to replace
              anatomy that may be missing, such as a leg or an arm, that is
              preventing a patient to achieve their full mobility potential.
            </p>

            <p>
              Orthotists and Prosthetic practitioners are integral members of
              the healthcare and rehabilitation team. Their unique expertise in
              ...
              patients' homes. How do you become an orthotist or prosthetist:
              From http://www.opcareers.org/professionals/practitioners/ “After
              ...
              Certification/Accreditation, International (BOC), or both. To
              learn more about the requirements for certification, please visit
              the ABC website or the BOC website.”
            </p>
